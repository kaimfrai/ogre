...
ApplicationContextSDL::ApplicationContextSDL(StringView appName) : ApplicationContextBase(appName)
{
}
...
auto ApplicationContextSDL::createWindow(StringView name, Ogre::uint32 w, Ogre::uint32 h, Ogre::NameValuePairList miscParams) -> NativeWindowPair
{
