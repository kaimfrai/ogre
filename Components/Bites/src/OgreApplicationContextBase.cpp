...
ApplicationContextBase::ApplicationContextBase(StringView appName)
{
    mAppName = appName;
...
auto ApplicationContextBase::createWindow(StringView name, Ogre::uint32 w, Ogre::uint32 h, Ogre::NameValuePairList miscParams) -> NativeWindowPair
{
...
void ApplicationContextBase::destroyWindow(StringView name)
{
...
void ApplicationContextBase::reconfigure(StringView renderer, Ogre::NameValuePairList &options)
{
