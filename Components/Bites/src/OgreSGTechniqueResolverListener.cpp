...
auto SGTechniqueResolverListener::handleSchemeNotFound(unsigned short schemeIndex, StringView schemeName, Ogre::Material *originalMaterial, unsigned short lodIndex, const Ogre::Renderable *rend) -> Ogre::Technique * {
