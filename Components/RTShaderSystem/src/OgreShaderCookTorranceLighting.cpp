...
//-----------------------------------------------------------------------
auto CookTorranceLighting::getType() const noexcept -> StringView { return Type; }
//-----------------------------------------------------------------------
...
auto CookTorranceLighting::setParameter(StringView name, StringView value) noexcept -> bool
{
    if (name == "texture")
    {
...
//-----------------------------------------------------------------------
auto CookTorranceLightingFactory::getType() const noexcept -> StringView { return CookTorranceLighting::Type; }
